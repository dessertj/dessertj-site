...
https://dessertj.org/apidocs/index.html?de/spricom/dessert/modules/ModuleRegistry.html[ModuleRegistry]:
...
The https://dessertj.org/apidocs/index.html?de/spricom/dessert/modules/fixed/JavaModules.html[JavaModules]
and https://dessertj.org/apidocs/index.html?de/spricom/dessert/modules/fixed/JdkModules.html[JdkModules]
...
https://dessertj.org/apidocs/index.html?de/spricom/dessert/util/AnnotationPattern.html[AnnotationPattern]:
