...
check is the parameter of this method. Then comes the requirement, which
...
----
include::{sample-dir}/src/test/java/de/spricom/dessert/introduction/SlicingSampleTest.java[]
----
